...
public class SelectRecipeStepActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.recycler_view_steps);
    ...
    class SimpleItemRecyclerViewAdapter
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            holder.stepId.setText(mValues.get(position).id);
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ViewHolder(View view) {
                super(view);
                mView = view;
                stepId = (TextView) view.findViewById(R.id.txtVw_recipe_step_id);
                mContentView = (TextView) view.findViewById(R.id.txtVw_recipe_step_short_description);
            }
