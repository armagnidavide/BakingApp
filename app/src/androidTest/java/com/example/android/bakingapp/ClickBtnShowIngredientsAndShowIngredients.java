...
public class ClickBtnShowIngredientsAndShowIngredients {
    @Rule
    ...
    public void click_recipe_to_open_SelectStepActivity() throws InterruptedException {
        ...
        onView(withId(R.id.selectStepActivity_btn_show_ingredients)).check(matches(isDisplayed()));
        onView(withId(R.id.selectStepActivity_btn_show_ingredients))
                .perform(click());
    }
}
